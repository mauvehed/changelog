...
commitsArray.forEach(commit => {
    if (commit.message.startsWith("feature: ")) {
        features.push(
            `* ${commit.message.replace("feature :", "")} ([${commit.sha.substring(0,6)}])(https://github.com/mauvehed/changelog/commit/${commit.sha}))\n`
        );
    }
    if (commit.message.startsWith("chores: ")) {
        chores.push(
            `* ${commit.message.replace("chores :", "")} ([${commit.sha.substring(0,6)}])(https://github.com/mauvehed/changelog/commit/${commit.sha}))\n`
        );
    }
});
